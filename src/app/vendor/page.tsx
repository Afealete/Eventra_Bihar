...
export default function VendorDetail() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      alert((error?.code ? `${error.code}: ` : "") + (error?.message || "Google login failed"));
    } finally {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start mb-8">
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <button className="ml-auto bg-[#8B000F] text-white px-6 py-2 rounded-lg font-semibold">
                    Book Now
                  </button>
                </div>
                <p className="text-black">
                  Dream Weddings Photography specialises in capturing authentic
                  moments across Bihar. We offer customizable packages and
                  reliable service for your big day.
                </p>
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white border border-gray-100 rounded-xl p-4 shadow-sm">
                  <div className="font-bold text-lg text-[#8B000F]">Basic</div>
          ...
          <aside className="bg-white rounded-2xl shadow p-4">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button className="w-full bg-[#8B000F] text-white px-4 py-2 rounded">
                Request Quote
              </button>
            </div>
          </aside>
